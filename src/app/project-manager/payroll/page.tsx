...
import ModalProjectPayroll from '../../../features/payroll/components/ModalProjectPayroll';
...
import formatRupiah from '../../../features/common/helpers/common.helper';
...
const PayrollPMPage = () => {
  ...
  return (
    <Stack className="container mx-auto">
      <ModalProjectPayroll opened={opened} onClose={close} />
      <Group justify="space-between" align="center">
        <Stack gap={5}>
          <Text className="text-base font-semibold text-custom_black md:text-xl">
            Management Payroll
          </Text>
          <Text className="text-base  text-neutral-400 md:text-lg">
            Gaji Anggota Tim
          </Text>
        </Stack>
        ...
        <BaseButton
          variant="primary"
          rightSection={<FaFileInvoiceDollar className="text-lg" />}
